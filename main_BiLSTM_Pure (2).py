...
RESULT_PATH = os.path.join(project_dir, 'PINN_RESULT', f'PURE_MODEL_EXT_TRAIN_RESULTS_RESET_PERIOD_{PREDICTION_STEPS}', f'run_{run_id}')
...
# Save file name
pure_trained_model_file_name = f'{base_model_file_name}_Pure_Trained_Model_{PREDICTION_STEPS}.pth' 

# Naming Conventions
csv_nor_physical_sensor_evaluation_results_file_name = f'{base_model_file_name}_Pure_NOR_Physical_Sensor_Evaluation_Results.csv'
scatter_plot_nor_physical_sensor_file_name = f'{base_model_file_name}_Pure_Scatter_Plot_NOR_Physical_Sensor'
line_plot_nor_physical_sensor_file_name = f'{base_model_file_name}_Pure_Line_Plot_NOR_Physical_Sensor'

csv_ext_physical_sensor_evaluation_results_file_name_1 = f'{base_model_file_name}_Pure_EXT_Physical_Sensor_Evaluation_Results_1.csv'
scatter_plot_ext_physical_sensor_file_name_1 = f'{base_model_file_name}_Pure_Scatter_Plot_EXT_Physical_Sensor_1'
line_plot_ext_physical_sensor_file_name_1 = f'{base_model_file_name}_Pure_Line_Plot_EXT_Physical_Sensor_1'

csv_ext_physical_sensor_evaluation_results_file_name_2 = f'{base_model_file_name}_Pure_EXT_Physical_Sensor_Evaluation_Results_2.csv'
scatter_plot_ext_physical_sensor_file_name_2 = f'{base_model_file_name}_Pure_Scatter_Plot_EXT_Physical_Sensor_2'
line_plot_ext_physical_sensor_file_name_2 = f'{base_model_file_name}_Pure_Line_Plot_EXT_Physical_Sensor_2'

csv_ext_physical_sensor_evaluation_results_file_name_3 = f'{base_model_file_name}_Pure_EXT_Physical_Sensor_Evaluation_Results_3.csv'
scatter_plot_ext_physical_sensor_file_name_3 = f'{base_model_file_name}_Pure_Scatter_Plot_EXT_Physical_Sensor_3'
line_plot_ext_physical_sensor_file_name_3 = f'{base_model_file_name}_Pure_Line_Plot_EXT_Physical_Sensor_3'
...
def main():
    ...
    base_regressor = PureRegressor( latent_dim=HIDDEN_DIM * 2, 
    ...
    trained_pure_model, trained_pure_regressor = load_model(
                                                            model=base_model, 
                                                            regressor=base_regressor, 
                                                            device=device, 
    ...
    for name, data in evaluation_datasets.items():
        print(f"\n=== MODEL EVALUATION ON DATASET >> {name} ===")
        y_true, y_pred, _, _, _, _ = evaluation_pure_physical_sensor(
            model=trained_pure_model,
            regressor=trained_pure_regressor,
            device=device,
