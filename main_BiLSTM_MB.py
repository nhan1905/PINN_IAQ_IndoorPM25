...
RESULT_PATH = os.path.join(project_dir, 'PINN_RESULT_sustain_check', f'MB_MODEL_EXT_TRAIN_RESULTS_RESET_PERIOD_{RESET_PERIOD}', f'run_{run_id}')
...
# Save file name
mb_trained_model_file_name = f'{base_model_file_name}_MB_Trained_Model.pth' 
...
csv_nor_virtual_sensor_autoreset_evaluation_results_file_name  = f'{base_model_file_name}_MB_NOR_Virtual_Sensor_Autoreset_Evaluation_Results.csv'
...
scatter_plot_nor_virtual_sensor_autoreset_file_name = f'{base_model_file_name}_MB_Scatter_Plot_NOR_Virtual_Sensor_Autoreset'
...
line_plot_nor_virtual_sensor_autoreset_file_name = f'{base_model_file_name}_MB_Line_Plot_NOR_Virtual_Sensor_Autoreset'
...
csv_ext_virtual_sensor_autoreset_evaluation_results_file_name_1 = f'{base_model_file_name}_MB_EXT_Virtual_Sensor_Autoreset_Evaluation_Results_1.csv'
...
scatter_plot_ext_virtual_sensor_autoreset_file_name_1 = f'{base_model_file_name}_MB_Scatter_Plot_EXT_Virtual_Sensor_Autoreset_1'
...
line_plot_ext_virtual_sensor_autoreset_file_name_1 = f'{base_model_file_name}_MB_Line_Plot_EXT_Virtual_Sensor_Autoreset_1'
...
csv_ext_virtual_sensor_autoreset_evaluation_results_file_name_2 = f'{base_model_file_name}_MB_EXT_Virtual_Sensor_Autoreset_Evaluation_Results_2.csv'
...
scatter_plot_ext_virtual_sensor_autoreset_file_name_2 = f'{base_model_file_name}_MB_Scatter_Plot_EXT_Virtual_Sensor_Autoreset_2'
...
line_plot_ext_virtual_sensor_autoreset_file_name_2 = f'{base_model_file_name}_MB_Line_Plot_EXT_Virtual_Sensor_Autoreset_2'
...
csv_ext_virtual_sensor_autoreset_evaluation_results_file_name_3 = f'{base_model_file_name}_MB_EXT_Virtual_Sensor_Autoreset_Evaluation_Results_3.csv'
...
scatter_plot_ext_virtual_sensor_autoreset_file_name_3 = f'{base_model_file_name}_MB_Scatter_Plot_EXT_Virtual_Sensor_Autoreset_3'
...
line_plot_ext_virtual_sensor_autoreset_file_name_3 = f'{base_model_file_name}_MB_Line_Plot_EXT_Virtual_Sensor_Autoreset_3'
...
OUTDOOR_COLS = ['OD_PM25', 'OD_PM10', 'OD_PM1', 'OD_TEMP', 'OD_RH']
...
def main():
    ...
    # Extreme Prediction 1 - Physical Sensor
    y_ext_ps_true_1, y_ext_ps_pred_1, _, _, _, _ = evaluation_mb_physical_sensor(
                                                                            model=trained_mb_model, 
                                                                            regressor=trained_mb_regressor, 
                                                                            device=device, 
    ...
    # Extreme Prediction 1 - Virtual Sensor
    y_ext_vr_true_1, y_ext_vr_pred_1, _, _, _, _ = evaluation_mb_virtual_sensor(
                                                                            model=trained_mb_model, 
                                                                            regressor=trained_mb_regressor, 
                                                                            device=device, 
                                                                            test_loader=ext_prediction_dataloader_1, 
    ...
    # Extreme Prediction 1 - Virtual Sensor - Autoreset
    y_ext_vr_ar_true_1, y_ext_vr_ar_pred_1, _, _, _, _ = evaluation_mb_virtual_sensor_autoreset(
                                                                                            model=trained_mb_model, 
                                                                                            regressor=trained_mb_regressor, 
                                                                                            device=device, 
                                                                                            test_loader=ext_prediction_dataloader_1,
